<?php
  class ArtatusPackedBox {
     ...
     */
    public function __construct(ArtatusBox $aBox, ArtatusItemList $aItemList, $aRemainingWidth, $aRemainingLength, $aRemainingDepth, $aRemainingWeight) {
      $this->box = $aBox;
